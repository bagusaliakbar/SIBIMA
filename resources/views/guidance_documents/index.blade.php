            ...
            <div class="flex items-center gap-2.5 overflow-x-auto custom-scrollbar pb-1 md:pb-0">
                <a href="{{ route('guidance-documents.index', ['category' => 'all', 'search' => $search]) }}"
                   class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap {{ ($category ?? 'all') === 'all' ? 'bg-slate-900 text-white dark:bg-white dark:text-slate-900 shadow-sm' : 'bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
                    ...
                    <span class="ml-0.5 px-2.5 py-0.5 rounded-full text-[10px] font-mono font-bold {{ ($category ?? 'all') === 'all' ? 'bg-white/20 text-white dark:bg-slate-900/20 dark:text-slate-900' : 'bg-slate-200 dark:bg-slate-600 text-slate-700 dark:text-slate-300' }}">
                        {{ $categoryCounts['all'] ?? 0 }}
                    </span>
                </a>

                <a href="{{ route('guidance-documents.index', ['category' => 'panduan_skripsi', 'search' => $search]) }}"
                   class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap {{ ($category ?? 'all') === 'panduan_skripsi' ? 'bg-indigo-600 text-white shadow-sm' : 'bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
                ...
                <a href="{{ route('guidance-documents.index', ['category' => 'format_template', 'search' => $search]) }}"
                   class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap {{ ($category ?? 'all') === 'format_template' ? 'bg-emerald-600 text-white shadow-sm' : 'bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
                ...
                <a href="{{ route('guidance-documents.index', ['category' => 'pedoman_bimbingan', 'search' => $search]) }}"
                   class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap {{ ($category ?? 'all') === 'pedoman_bimbingan' ? 'bg-amber-600 text-white shadow-sm' : 'bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
                ...
                <a href="{{ route('guidance-documents.index', ['category' => 'lainnya', 'search' => $search]) }}"
                   class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap {{ ($category ?? 'all') === 'lainnya' ? 'bg-slate-700 text-white shadow-sm' : 'bg-slate-100 dark:bg-slate-700/60 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700' }}">
