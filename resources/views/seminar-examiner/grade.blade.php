<x-app-layout>
    ...
    <div class="w-full space-y-6">
        ...
        <div class="bg-white dark:bg-slate-800/50 dark:backdrop-blur-xl rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700/50 overflow-hidden">
            ...
            <form action="{{ route('seminar-examiner.store-grading', $detail->id) }}" method="POST" class="p-6 space-y-6 pb-28" x-data="{
                scores: {
                        ...
                        <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-4 align-top">
                                    <div class="space-y-2">
                                        <!-- Stepper Input -->
                                        <div class="flex items-center rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-xs overflow-hidden focus-within:ring-2 focus-within:ring-indigo-500">
                                            <button type="button" 
                                        ...
                                        <div class="flex items-center justify-center gap-1 flex-wrap">
                                            <template x-for="val in presets" :key="val">
                                                <button type="button" 
                                                        ...
                                                        :class="scores.presentation == val ? 'bg-indigo-600 text-white font-black shadow-xs ring-1 ring-indigo-500' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-indigo-950/50'" 
                                        ...
                                        <div class="flex items-center justify-center gap-1 flex-wrap">
                                            <template x-for="val in presets" :key="val">
                                                <button type="button" 
                                                        ...
                                                        :class="scores.explanation == val ? 'bg-indigo-600 text-white font-black shadow-xs ring-1 ring-indigo-500' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-indigo-950/50'" 
                                                        class="px-1.5 py-0.5 rounded-md text-[9px] font-bold transition-all" 
                                                        x-text="val">
                                                </button>
                                            </template>
                                        ...
                                        <div class="flex items-center justify-center gap-1 flex-wrap">
                                            <template x-for="val in presets" :key="val">
                                                <button type="button" 
                                                        ...
                                                        :class="scores.writing == val ? 'bg-indigo-600 text-white font-black shadow-xs ring-1 ring-indigo-500' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:bg-indigo-50 hover:text-indigo-600 dark:hover:bg-indigo-950/50'" 
                                                        class="px-1.5 py-0.5 rounded-md text-[9px] font-bold transition-all" 
                                                        x-text="val">
                                                </button>
                                            </template>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-col sm:flex-row items-center justify-between gap-3">
                        ...
                        <div class="flex items-center gap-3 sm:gap-5 w-full sm:w-auto justify-between sm:justify-start">
                            <div class="flex items-center gap-2.5">
                                <div class="w-9 h-9 rounded-xl bg-indigo-500/10 dark:bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 flex items-center justify-center font-black text-sm shadow-xs">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-baseline gap-2">
                                        ...
                                        <span class="text-[10px] font-black text-indigo-700 dark:text-indigo-300 bg-indigo-100 dark:bg-indigo-950/80 px-2 py-0.5 rounded-md border border-indigo-200 dark:border-indigo-800" x-text="gradeLetter">A</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center gap-3 w-full sm:w-auto justify-end">
                            <button type="submit" class="w-full sm:w-auto px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-black uppercase tracking-wider shadow-lg shadow-indigo-500/25 transition-all flex items-center justify-center gap-2">
