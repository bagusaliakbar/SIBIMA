<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <x-breadcrumb :links="[
                    ['name' => 'Penguji Seminar', 'url' => route('seminar-examiner.index')]
                ]" />
                ...
                <table class="w-full text-left text-sm">
                    <thead>
                        <tr class="bg-slate-50/50 dark:bg-slate-900/50 text-slate-400 text-[10px] font-bold uppercase tracking-widest border-b border-slate-50 dark:border-slate-700">
                            ...
                            <th class="px-6 py-4">Jadwal Seminar</th>
                        ...
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-700/50 transition-colors group">
                            <td class="px-6 py-5">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 rounded-xl bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 flex items-center justify-center mr-4 font-bold text-sm shadow-sm group-hover:scale-110 transition-transform">
                            ...
                            <td class="px-6 py-5 text-right">
                                <a href="{{ route('seminar-examiner.show', $exam->id) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-600 transition-all shadow-sm">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <h3 class="text-slate-400 font-bold text-sm uppercase tracking-widest">Tidak Ada Jadwal Menguji</h3>
                                    <p class="text-[11px] text-slate-400 mt-1 italic">Anda belum diplot sebagai penguji seminar pada jadwal manapun.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
