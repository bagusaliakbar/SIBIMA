            ...
            <form action="{{ route('repositories.books') }}" method="GET" class="w-full">
                <div class="flex flex-col sm:flex-row items-stretch gap-3 w-full">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-2.5 shrink-0">
                        ...
                        @if(!empty($query) || !empty($topic) || $source !== 'all' || $access !== 'all')
                            <a href="{{ route('repositories.books') }}" 
                               ...
                               title="Reset pencarian dan kembali ke halaman awal">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 sm:p-12 border border-slate-200/80 dark:border-slate-700/80 text-center space-y-6">
                ...
                <div class="max-w-md mx-auto space-y-2">
                    <h3 class="text-lg font-black text-slate-800 dark:text-slate-100 tracking-tight">
                        Cari dan Temukan Buku Teks Akademik
                    </h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                        Pilih salah satu pilar topik Sistem Informasi di atas atau masukkan kata kunci pencarian (judul buku, pengarang, atau istilah IT) untuk menjelajahi ribuan buku referensi dan e-book open access.
                    </p>
                </div>
                <div class="flex flex-wrap items-center justify-center gap-2 pt-2">
                    <span class="text-xs font-bold text-slate-400 dark:text-slate-500 mr-1">Rekomendasi Topik:</span>
                    <a href="{{ route('repositories.books', ['topic' => 'basis_data']) }}" class="px-3 py-1.5 rounded-xl text-xs font-bold bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 transition-all border border-slate-200/80 dark:border-slate-700/80">🗄️ Basis Data</a>
                    <a href="{{ route('repositories.books', ['topic' => 'analisis_desain']) }}" class="px-3 py-1.5 rounded-xl text-xs font-bold bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 transition-all border border-slate-200/80 dark:border-slate-700/80">💼 Analisis & Desain (UML)</a>
                    <a href="{{ route('repositories.books', ['topic' => 'rekayasa_web']) }}" class="px-3 py-1.5 rounded-xl text-xs font-bold bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 transition-all border border-slate-200/80 dark:border-slate-700/80">🌐 RPL & Web</a>
                    <a href="{{ route('repositories.books', ['topic' => 'ai_data_science']) }}" class="px-3 py-1.5 rounded-xl text-xs font-bold bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-orange-500 hover:text-white dark:hover:bg-orange-600 transition-all border border-slate-200/80 dark:border-slate-700/80">🤖 AI & Data Science</a>
                </div>
            </div>
        @else
        <!-- RESULTS SECTION -->
