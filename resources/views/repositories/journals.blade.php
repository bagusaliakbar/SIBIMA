<x-app-layout>
    ...
    <div class="w-full space-y-6" x-data="academicJournalApp()">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-5 shadow-sm space-y-4">
            ...
            @php
                $dosenList = [
                    'Tepi Peirisal', 'Maya Destriani', 'Tazkia Salsabila Ardan',
                    'Bagus Ali Akbar', 'M. Hairiyanov', 'Santi Purwanti',
                    'Rino Guphita', 'Sofwandi Noor', 'Rakhmayudhi',
                    'Syarif Hidayat', 'Jaja', 'Caca Arif Herdian',
                    'Bambang Tjahjo Utomo', 'Digyo', 'Achmad Syafaat',
                    'Restu Mahardika', 'Rusnedi AG',
                ];
            @endphp
        ...
        <template x-teleport="body">
            ...
            <div class="flex min-h-screen items-center justify-center p-4" style="z-index: 100000 !important;">
                <div class="relative bg-white dark:bg-slate-800 rounded-3xl max-w-xl w-full p-6 sm:p-7 shadow-2xl border border-slate-200/80 dark:border-slate-700 space-y-5"
                    ...
                    <!-- Paper Mini Preview -->
                    <div class="p-3.5 bg-slate-50 dark:bg-slate-900 rounded-xl space-y-1">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <div class="p-4 bg-slate-900 dark:bg-slate-950 text-slate-100 rounded-2xl font-mono text-xs leading-relaxed max-h-48 overflow-y-auto select-all"
                        ...
                        <div class="flex items-center justify-between text-[11px] text-slate-500 dark:text-slate-400 px-1">
                            <span x-show="activeCitationFormat === 'fasilkom'">
                                💡 Format resmi panduan skripsi FASILKOM UNSUB. Siap disalin langsung ke lembar daftar pustaka Microsoft Word.
                            </span>
                            <span x-show="activeCitationFormat === 'ris'">
                                💡 Format metadata standar untuk diimpor ke Mendeley Desktop/Reference Manager, Zotero, dan EndNote.
                            </span>
                            <span x-show="activeCitationFormat === 'bibtex'">
                                💡 Format entri sitasi untuk penulisan skripsi berbasis LaTeX / Overleaf.
                            </span>
        ...
        function academicJournalApp() {
            return {
                ...
                copyFasilkomWord() {
                    ...
                    // Copy rich text HTML so Word preserves italicized journal name
