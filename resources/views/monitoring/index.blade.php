        ...
        <x-table-card 
            ...
            <x-slot name="headerActions">
                <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                    ...
                    <a href="{{ route('admin.letter-settings.index') }}" class="inline-flex items-center px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all shadow-sm whitespace-nowrap gap-2 group border border-slate-200 dark:border-slate-700">
