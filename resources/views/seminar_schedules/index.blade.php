                        ...
                        <div class="p-6 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white space-y-4">
                            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                                ...
                                <div class="flex items-center gap-2.5 shrink-0">
                                    <a href="{{ route('seminar-schedules.export-pdf', $schedule) }}" class="inline-flex items-center px-4 py-2 bg-white/10 hover:bg-white/20 text-white border border-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all">
                                ...
                                <div class="flex items-center gap-2.5 px-3 py-2 bg-white/5 rounded-xl border border-white/5">
                                    ...
                                    <div class="truncate">
                                        ...
                                        @if($schedule->meeting_link)
                                            <a href="{{ $schedule->meeting_link }}" target="_blank" class="font-bold text-sky-300 hover:text-white hover:underline truncate block">Buka Link &rarr;</a>
                                        @else
            ...
            <x-table-card 
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                        ...
                        @empty
                            <x-empty-state colspan="5" description="Agenda pelaksanaan seminar belum tersedia untuk gelombang ini." icon="calendar" />
                        @endforelse
                    </tbody>
                </table>
            </x-table-card>
