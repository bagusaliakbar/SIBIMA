<x-app-layout>
    ...
    <div class="w-full mx-auto" x-data="scheduleForm()">
        <form action="{{ route('seminar-schedules.update', $seminarSchedule) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 rounded-lg overflow-hidden mb-6">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="col-span-2">
                        ...
                        <x-text-input id="title" name="title" type="text" class="mt-1 block w-full text-sm" value="{{ $seminarSchedule->title }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="location" name="location" type="text" class="mt-1 block w-full text-sm" value="{{ $seminarSchedule->location }}" placeholder="Contoh: Online atau Ruang Rapat Lt. 2" />
                    ...
                    <div>
                        ...
                        <x-text-input id="meeting_link" name="meeting_link" type="url" class="mt-1 block w-full text-sm" value="{{ $seminarSchedule->meeting_link }}" placeholder="https://meet.google.com/xxx-xxxx-xxx" />
