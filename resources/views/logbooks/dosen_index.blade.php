                                ...
                                <div class="flex items-center gap-3.5">
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        <div class="flex items-center gap-2 flex-wrap">
                                            <span class="font-bold text-slate-900 dark:text-white tracking-tight text-xs sm:text-sm">
                                            ...
                                            @if($waNumber)
                                                <a href="https://wa.me/{{ $waNumber }}?text={{ $waMessage }}" 
                                                   ...
                                                   class="inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-500/10 hover:bg-emerald-500/20 dark:bg-emerald-500/15 dark:hover:bg-emerald-500/25 text-emerald-700 dark:text-emerald-300 rounded-full text-[10px] font-bold transition-all hover:scale-105 active:scale-95 cursor-pointer"
                                            ...
                                            @else
                                                <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 rounded-full text-[9px] font-medium" title="Nomor WhatsApp belum didaftarkan oleh mahasiswa">
