                                ...
                                <div class="bg-rose-50/50 dark:bg-rose-500/5 p-4 rounded-xl border border-rose-100 dark:border-rose-500/20 shadow-sm">
                                    ...
                                    <div class="mt-3 flex items-center gap-3">
                                        @if($firstExaminerMessage->file_path)
                                            <a href="{{ route('download.private', ['path' => $firstExaminerMessage->file_path]) }}" target="_blank" class="inline-flex items-center text-[9px] font-black text-rose-600 uppercase tracking-widest hover:underline">
