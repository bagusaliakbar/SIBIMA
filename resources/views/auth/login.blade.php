<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-xs text-slate-500 mt-1 font-medium">Sistem Informasi Bimbingan Mahasiswa FASILKOM</p>
    </div>
        ...
        <div>
            ...
            <div class="relative rounded-xl">
                ...
                <button type="button" @click="showPassword = !showPassword" 
                    ...
                    <svg x-show="showPassword" x-cloak class="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.025 10.025 0 0110.123 3.937M15 12a3 3 0 11-6 0 3 3 0 016 0zm6 0c0 .416-.027.828-.08 1.233M3 3l18 18"></path>
                    </svg>
                </button>
            </div>
