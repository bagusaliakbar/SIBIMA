...
@section('message')
    Sesi keamanan halaman ini telah kedaluwarsa karena tidak ada aktivitas dalam waktu lama. Silakan muat ulang (refresh) halaman untuk memperbarui token keamanan dan melanjutkan.
@endsection
...
<div class="flex items-center justify-between gap-4 text-xs text-slate-500 dark:text-slate-400 bg-slate-50/60 dark:bg-slate-800/40 p-3.5 rounded-2xl border border-slate-100 dark:border-slate-800/80 text-left">
    <span class="font-medium">💡 Tip: Segarkan halaman sebelum mengirim formulir panjang yang telah lama terbuka.</span>
</div>
@endsection
