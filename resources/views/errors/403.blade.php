...
@section('message')
    Maaf, akun Anda tidak memiliki hak akses untuk membuka halaman atau fitur ini. Pastikan Anda telah masuk dengan akun dan peran (*role*) yang sesuai untuk tindakan ini.
@endsection
...
@section('extra')
<div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-slate-500 dark:text-slate-400 bg-slate-50/60 dark:bg-slate-800/40 p-3.5 rounded-2xl border border-slate-100 dark:border-slate-800">
    <span class="font-medium">Memerlukan hak akses khusus?</span>
    <span class="font-bold text-slate-700 dark:text-slate-300">Hubungi Admin / Kaprodi</span>
</div>
@endsection
