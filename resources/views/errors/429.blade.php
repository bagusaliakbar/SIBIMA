...
@section('code', '429')
@section('status_badge', 'Too Many Requests')

@section('message')
    Sistem mendeteksi terlalu banyak permintaan secara beruntun dari perangkat Anda. Harap beri jeda sejenak (sekitar 1-2 menit) sebelum memuat kembali.
@endsection
...
<div class="pt-8 border-t border-slate-200/80 dark:border-slate-800 text-xs font-semibold text-slate-500 dark:text-slate-400">
    <span>🔒 Pembatasan ini otomatis terbuka kembali setelah jeda beberapa saat.</span>
</div>
@endsection
