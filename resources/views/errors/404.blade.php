...
@section('message')
    Halaman atau dokumen yang Anda cari tidak dapat ditemukan. Kemungkinan tautan rusak, data telah dipindahkan, atau alamat URL yang dimasukkan kurang tepat.
@endsection
