                                ...
                                <td class="py-4 px-6 text-right">
                                    @if(!$thesis->pembimbing1 || !$thesis->pembimbing2)
                                        <div x-data="{ openAssignModal: false }" class="inline-block whitespace-nowrap">
                                            <button @click="openAssignModal = true" class="inline-flex items-center justify-center gap-1.5 px-3.5 py-1.5 bg-orange-600 hover:bg-orange-700 active:scale-95 text-white rounded-lg text-xs font-bold transition-all shadow-xs shadow-orange-500/20 hover:scale-[1.02] cursor-pointer whitespace-nowrap shrink-0">
                                    ...
                                    @else
                                        <div class="flex justify-end items-center gap-1.5 shrink-0 whitespace-nowrap" x-data="{ openEditModal: false }">
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="inline-flex items-center justify-center gap-1 px-3 py-1.5 bg-white dark:bg-slate-800 hover:bg-rose-50 dark:hover:bg-rose-950/40 text-rose-600 dark:text-rose-400 border border-slate-200 dark:border-slate-700 hover:border-rose-300 dark:hover:border-rose-800 rounded-lg text-xs font-bold transition-all shadow-2xs hover:scale-[1.02] active:scale-95 cursor-pointer whitespace-nowrap shrink-0"
                                            ...
                                            <button type="button"
                                                    ...
                                                    class="inline-flex items-center justify-center gap-1 px-3 py-1.5 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700/80 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 rounded-lg text-xs font-bold transition-all shadow-2xs hover:scale-[1.02] active:scale-95 cursor-pointer whitespace-nowrap shrink-0"
                                            ...
                                            <a href="{{ route('theses.logbooks', $thesis->id) }}" 
                                               class="inline-flex items-center justify-center gap-1 px-3 py-1.5 bg-orange-600 hover:bg-orange-700 active:scale-95 text-white rounded-lg text-xs font-bold transition-all shadow-xs shadow-orange-500/20 hover:scale-[1.02] cursor-pointer whitespace-nowrap shrink-0"
