            ...
            <form action="{{ route('theses.store') }}" method="POST" class="space-y-6" 
                ...
                <div class="pt-5 flex items-center gap-3">
                    <button type="submit" 
                            ...
                            class="inline-flex justify-center items-center px-6 py-2.5 bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 text-white text-[10px] font-black rounded-xl uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-all shadow-lg shadow-orange-500/20 cursor-pointer">
                        <template x-if="!submitting">
                            <span>Submit Pengajuan</span>
                        </template>
                        <template x-if="submitting">
                            <span class="flex items-center gap-1.5">
                                <svg class="animate-spin -ml-1 mr-1.5 h-3.5 w-3.5 text-white" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                Memproses...
                            </span>
                        </template>
                    </button>
