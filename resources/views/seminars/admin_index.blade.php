                                            ...
                                            <div class="flex items-start justify-center min-h-screen px-4 text-center">
                                                ...
                                                <div class="relative w-full my-8 sm:my-16 bg-white dark:bg-slate-800 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:max-w-lg border border-slate-100 dark:border-slate-700">
                                                    <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-slate-50/50 dark:bg-slate-900/50">
                                                        <div>
                                                            <h3 class="text-sm font-black text-slate-800 dark:text-slate-100 uppercase tracking-wider">Validasi Berkas Seminar</h3>
                                                    ...
                                                    <form action="{{ route('seminar-applications.validate', $app->id) }}" method="POST">
                                                        ...
                                                        <div class="px-6 py-6 space-y-5 max-h-[65vh] overflow-y-auto">
                                                            <div>
                                                                <label class="block text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest mb-3">Verifikasi Setiap Berkas:</label>
                                                                <div class="space-y-3">
                                                                    @foreach(['file_acc_pembimbing' => 'ACC Pembimbing', 'file_pembayaran' => 'Bukti Bayar', 'file_kartu_bimbingan' => 'Logbook', 'file_skripsi' => 'Draf Skripsi', 'file_formulir' => 'Formulir'] as $field => $label)
                                                                        <div class="p-3.5 bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700">
                                                                            <div class="flex items-center justify-between mb-2">
                                                                                <a href="{{ $app->$field }}" target="_blank" class="text-xs font-bold text-slate-800 dark:text-slate-200 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center gap-1.5">
                                                                                    <span>{{ $label }}</span>
